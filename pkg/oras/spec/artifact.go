...
const MediaTypeArtifactManifest = "application/vnd.cachedtarget.artifact.manifest.v1+json"

// Artifact describes an artifact manifest.
// This structure provides `application/vnd.cachedtarget.artifact.manifest.v1+json` mediatype when marshalled to JSON.
//
